...
const Grid: React.FC<{ size: number, gridNumbers: number[], setGridNumbers: (gridNumbers: number[]) => void, gridStatus: number[] }> = ({ size, gridNumbers, setGridNumbers, gridStatus }) => {
    // N x N grid
